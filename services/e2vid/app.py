...
def detect(req: DetectRequest):
    # Canonical single-file cache — always overwritten on a fresh run.
    cache_path = RECON_ROOT / req.sequence_id / "detections_e2vid.json"
    ...
    BATCH = 32
    REPORT_EVERY = 10  # report after every N batches
